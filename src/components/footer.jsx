      ...
      <div className="container mx-auto px-4 py-4 sm:py-6 lg:py-8">
        <div className="flex flex-col items-center gap-6 sm:gap-8 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full lg:w-auto">
            ...
            <button
              className="px-4 sm:px-6 py-2 sm:py-2.5 bg-coral-500 rounded-lg hover:bg-coral-600 
          ...
          <div className="bg-coral-500 rounded-xl p-6 max-w-sm xl:w-[25%]">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-white font-semibold">
                Krijg het beste tarief voor uw vrachttransport
              </h3>
            </div>
            <p className="text-white/80 text-sm mb-4">
              24/7 klantenondersteuning en deskundig advies. Tot 70% besparing
              op verzendkosten bij alle grote vervoerders
            </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="group">
                  <a
                    href="#"
                    className="text-white transition-colors group-hover:text-orange"
                  >
                    <span className="text-lightGreen2 text-xl transition-colors group-hover:text-orange">
                      &#8594;
                    </span>{" "}
                ...
                <li className="group">
                  ...
                  >
                    <span className="text-lightGreen2 text-xl group-hover:text-orange">
                      &#8594;
                    </span>{" "}
                    Spoorvrachtvervoer
                  </a>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="mailto:info@adelaartransport.nl" className="text-white">info@adelaartransport.nl</a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <a href="tel:+31630013015" className="text-white">+31630013015</a>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-400 text-sm">
              © 2023 <span className="text-coral-500">Adelaar Transport</span>{" "}
              transport en Logistiek / Alle rechten voorbehouden
            </p>
