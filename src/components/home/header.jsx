...
const Header = () => {
  return (
    <header className="bg-green3 text-gray-200 flex">
        <div className="bg-white p-auto justify-center items-center w-[229px] h-[111px] flex"><Link href="/">
    <img
      ...
      <div className="bg-green3 ml-[17%]">
        <div className="container mx-auto flex justify-between items-center px-4">
          ...
          <nav className="hidden lg:flex space-x-6 m-auto">
            <Link href="/" className="text-orange hover:text-gray-200">
              Home
            </Link>
            <Link href="/services" className="text-gray-200 hover:text-orange">
              Services
            </Link>
            <Link href="/contact" className="text-gray-200 hover:text-orange">
              Contact
            </Link>
            <Link href="/projects" className="text-gray-200 hover:text-orange">
              Projects
            </Link>
            <Link href="/blog" className="text-gray-200 hover:text-orange">
              Blog
            </Link>
          </nav>
          </div>
