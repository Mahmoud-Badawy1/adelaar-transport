...
const WhyChooseUs = () => {
  ...
  return (
    <section className="relative min-h-[600px] lg:min-h-[800px] z-10">
      ...
      <div className="relative flex flex-col lg:flex-row mx-auto">
        ...
        <div className="w-full lg:w-[39.5%] bg-orange p-6 lg:p-10 mt-8 lg:mt-0 lg:translate-y-[62.5%] relative">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start gap-5 lg:gap-8 z-20">
            ...
            <div className="w-full h-48 lg:w-48 lg:h-48 bg-gray-200 rounded-xl flex-shrink-0 bg-cover" style={{ backgroundImage: "url('/emp.jpg')" }} />
          </div>
      ...
      {/* Gray Background */}
      <div className="absolute top-0 right-0 w-full lg:w-[70%] h-full lg:h-[93.8%] bg-gray-200 -z-10 bg-cover" style={{ backgroundImage: "url('/cont.jpg')" }}/>
    </section>
  );
};
